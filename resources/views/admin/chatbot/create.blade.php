                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('admin.chatbot.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="footer" id="footer" rows="2" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="Send MENU to continue or EXIT to quit.">{{ old('footer', '™') }}</textarea>
                            @error('footer')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                            <p class="mt-1 text-xs text-gray-500">
                            ...
                            <div class="mt-2 p-3 bg-amber-50 rounded text-sm text-amber-800">
                                <strong>⚠️ Note:</strong> Default footer is "™" - edit this to add navigation instructions like "Send MENU to continue or EXIT to quit."
                            </div>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <input type="url" name="include_url" id="include_url" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="https://example.com/api/content" value="{{ old('include_url') }}">
                            @error('include_url')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                            <p class="mt-1 text-xs text-gray-500">
